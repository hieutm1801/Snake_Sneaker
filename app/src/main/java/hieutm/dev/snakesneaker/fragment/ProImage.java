...
public class ProImage extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        llRemove = view.findViewById(R.id.ll_remove_pro_image);
        llImage = view.findViewById(R.id.ll_image_pro_image);
        ...
        llImage.setOnClickListener(v -> requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE_PERMISSION));
