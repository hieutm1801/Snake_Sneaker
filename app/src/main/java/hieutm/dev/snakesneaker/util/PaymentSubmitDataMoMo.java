...
public class PaymentSubmitDataMoMo {

    private final Activity activity;

    public PaymentSubmitDataMoMo(Activity activity) {
        this.activity = activity;
    }

    public void payMeantSubmit(String userId, String couponId, String addressId, String cartIds, String cartType, String gateway, String paymentId, String razorpayOrderId, String orderId, PaymentSubmit paymentSubmit) {
        ...
        String a = API.toBase64(jsObj.toString());
